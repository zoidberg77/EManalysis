...
class FeatureExtractor():
	...
	def compute_vae_shape(self):
		...
		'''
		with h5py.File(os.path.join(cfg.DATASET.ROOTF,'shapef.h5'), 'r') as f:
			return f['shape']
	...
	def compute_vae_texture(self):
		...
		'''
		with h5py.File(os.path.join(cfg.DATASET.ROOTF,'texturef.h5'), 'r') as f:
			return f['texture']
	...
	def compute_vae_ptc_shape(self):
		...
		:returns latent shape features for every object
		'''
		with h5py.File(os.path.join(cfg.DATASET.ROOTF,'ptc_shapef.h5'), 'w') as f:
			return f['ptc_shape']
