...
def build_lr_scheduler(cfg: CfgNode, optimizer: torch.optim.Optimizer, iter_per_epoch: int) -> torch.optim.lr_scheduler._LRScheduler:
	'''Build a LR scheduler.'''
	return LRScheduler(optimizer, cfg.SSL.OPTIMIZER_LR, cfg.SSL.EPOCHS, iter_per_epoch)
